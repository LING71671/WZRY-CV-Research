...
# 从 skills 包导入基类和配置类（legacy 模块依赖活跃的 skills 基础设施）
from wzry_ai.skills.skill_base import SkillBase, SkillConfig, SkillRegistry, SkillType
# SkillBase: 技能抽象基类
# SkillConfig: 技能配置数据类
...
# 从 skills 包导入具体技能类
from wzry_ai.skills.skill_types import DamageSkill, AutoMaintenanceSkill
# DamageSkill: 伤害技能类，用于普攻管理
# AutoMaintenanceSkill: 自动维护技能类，用于买装备和升级

# 从 skills 包导入配置获取函数
from wzry_ai.skills.hero_skill_configs import get_hero_skill_config
