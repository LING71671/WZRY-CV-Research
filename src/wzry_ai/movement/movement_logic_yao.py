...
from wzry_ai.config.heroes.mapping import convert_priority_heroes, get_hero_chinese  # 导入英雄名称转换函数
...
# 从统一按键配置导入移动方向按键
from wzry_ai.config.keys import KEY_MOVE_UP, KEY_MOVE_DOWN, KEY_MOVE_LEFT, KEY_MOVE_RIGHT
