...
class GameServices:
    ...
    def _init_emulator(self) -> bool:
        ...
        try:
            ...
            logger.info(f"分辨率: {self.emulator_config.client_size[0]}x{self.emulator_config.client_size[1]}")
            return True
    ...
    def _init_state_detection(self):
        ...
        self.template_matcher = TemplateMatcher(template_folder='image/', match_scale=1.0)
        self.click_executor = ClickExecutor(adb_device=self.adb_device, use_adb=True)
    ...
    def _init_scrcpy(self):
        ...
        self.scrcpy_tool = ScrcpyTool(device_serial=self.adb_device)
    ...
    def _start_battle_system(self) -> bool:
        ...
        try:
            ...
            battle_thread.start()
            self.thread_supervisor.register_thread("battle_system", battle_thread)
    ...
    def _start_skill_system(self) -> bool:
        ...
        try:
            ...
            skill_thread.start()
            self.thread_supervisor.register_thread("skill_system", skill_thread)
