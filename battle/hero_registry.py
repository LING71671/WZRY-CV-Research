...
HERO_REGISTRY = {
    ...
    "蔡文姬": {
        "skill_module": "skills.caiwenji_skill_logic_v2",
        "skill_class": "CaiwenjiSkillLogic",
        "decision_module": "battle.generic_support_decision",
        "decision_class": "GenericSupportDecisionMaker",
        "has_attach": False,
    },
    "明世隐": {
        "skill_module": "skills.mingshiyin_skill_logic_v2",
...
def get_hero_name_or_default(hero_name: str) -> str:
    ...
    if hero_name:
        return hero_name
    from config import DEFAULT_SUPPORT_HERO
